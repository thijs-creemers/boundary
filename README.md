...
{:deps {org.boundary-app/boundary-core {:mvn/version "1.0.1-alpha-40"}}}

;; Full web application stack
{:deps {org.boundary-app/boundary-platform {:mvn/version "1.0.1-alpha-40"}
        org.boundary-app/boundary-user     {:mvn/version "1.0.1-alpha-40"}
        org.boundary-app/boundary-admin    {:mvn/version "1.0.1-alpha-40"}}}
```

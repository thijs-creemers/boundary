...
(defn generate-http-file
  ...
  (let [module-name (:module-name ctx)
    ...
    (str "(ns boundary." module-name ".shell.http\n"
         ...
         "   \n"
         "   Interceptor Hooks:\n"
         "     Add :interceptors vector to methods for cross-cutting concerns:\n"
         "     - Authentication: 'boundary.platform.shell.http.auth-interceptors/require-authenticated\n"
         "     - Authorization: 'boundary.platform.shell.http.auth-interceptors/require-role\n"
         "     - Audit Logging: 'boundary.platform.shell.http.audit-interceptors/log-action\n"
         "     - Rate Limiting: 'boundary.platform.shell.http.rate-limit-interceptors/rate-limit\n"
         "   \n"
         "   Example with interceptors:\n"
         "     {:post {:handler (create-handler service)\n"
         "             :interceptors ['boundary.platform.shell.http.auth-interceptors/require-authenticated\n"
         "                            'boundary.platform.shell.http.audit-interceptors/log-action]}}\"\n"
         "  [service]\n"
         "  [{:path \"/" entity-plural "\"\n"
         "    :methods {:get {:handler (fn [req] {:status 200 :body []})\n"
         "                    :summary \"List " entity-plural "\"}\n"
         "              :post {:handler (fn [req] {:status 201 :body {}})\n"
         "                     :summary \"Create " entity-lower "\"\n"
         "                     ;; TODO: Add interceptors here for auth, audit, etc.\n"
         "                     ;; :interceptors ['your.module/require-authenticated\n"
         "                     ;;                'your.module/log-action]\n"
         "                     }}}\n"
         "   {:path \"/" entity-plural "/:id\"\n"
         "    :methods {:get {:handler (fn [req] {:status 200 :body {}})\n"
         "                    :summary \"Get " entity-lower " by ID\"}\n"
         "              :put {:handler (fn [req] {:status 200 :body {}})\n"
         "                    :summary \"Update " entity-lower "\"\n"
         "                    ;; TODO: Add interceptors here\n"
         "                    }\n"
         "              :delete {:handler (fn [req] {:status 204})\n"
         "                       :summary \"Delete " entity-lower "\"\n"
         "                       ;; TODO: Add interceptors here\n"
         "                       }}}])\n"
         "\n"

...
____
*The Clojure framework* with enforced Functional Core / Imperative Shell architecture, independently deployable modules, and enterprise features out of the box.
____
...
* link:guides/operations[Deploy to Production]
...
* *Documentation:* See the https://github.com/thijs-creemers/boundary/tree/main/docs-site[docs-site/] directory

...
[NOTE]
====
Historical migration record: examples and file references describe the repository at migration time and may intentionally include legacy paths.
====
...
**File:** `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/user/ports.clj`
...
(defprotocol IUserService
  ...
  ;; Session Management
  (authenticate-user [this user-id user-id session-data]
...
**File:** `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/user/shell/service.clj`
...
* `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/user/shell/cli.clj` - CLI command handlers
* `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/user/shell/http.clj` - HTTP route handlers
...
(defprotocol IUserRepository
  ...
  (find-users [this user-id filters])
...
(ports/find-user-by-email user-service email user-id)
...
(ports/get-user-by-email user-service email user-id)
...
* link:https://github.com/thijs-creemers/boundary/blob/main/AGENTS.md[Boundary Architecture Guide]

---
title: "Dynamic JDBC Driver Loading System"
weight: 14
---
...
clojure -M:test:db/h2    # Automatically loads what test config needs
...
* link:database-adapters[Database Adapter Architecture] - Protocol-based adapter system
* link:../reference/multi-db-usage[Multi-Database Usage Guide] - Working with multiple databases
* link:configuration-and-env[Configuration Management] - Environment configuration
...
For detailed usage examples and configuration patterns, see the link:database-adapters[Database Adapter Architecture] documentation.

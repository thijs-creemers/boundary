...
* link:database-adapters.adoc[Database Adapter Architecture] - Protocol-based adapter system
* link:../reference/multi-db-usage.adoc[Multi-Database Usage Guide] - Working with multiple databases
* link:configuration-and-env.adoc[Configuration Management] - Environment configuration
...
For detailed usage examples and configuration patterns, see the link:database-adapters.adoc[Database Adapter Architecture] documentation.

...
- Our IRouter protocol: `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/platform/ports.clj`
- Reitit adapter (working): `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/platform/shell/http/reitit_router.clj`

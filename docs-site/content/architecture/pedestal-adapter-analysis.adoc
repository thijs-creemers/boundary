...
**Status**: 🔴 **BLOCKED** - Architectural incompatibility discovered
...
1. Abandon Pedestal adapter (stick with Reitit) ← **Selected**
...
**Assumptions**:
- Ring handler pattern (request → response)
...
=== Option 1: Abandon Pedestal Adapter ⭐ **RECOMMENDED**
...
1. ✅ **Delete draft Pedestal adapter code**
...
2. ✅ **Remove Pedestal dependencies from deps.edn**
...
4. ✅ **Focus on normalized routing format**
...
- Our IRouter protocol: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/ports/http.clj`
- Reitit adapter (working): `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/http/reitit_router.clj`

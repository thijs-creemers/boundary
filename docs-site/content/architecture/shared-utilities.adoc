...
**Prerequisites:** Understanding of link:overview.adoc[Architecture Overview] and basic Clojure concepts
...
1. **link:components.adoc[Component Architecture]** - How utilities fit into the overall architecture
2. **link:data-flow.adoc[Data Flow Architecture]** - Validation and transformation pipelines  

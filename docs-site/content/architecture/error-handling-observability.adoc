...
* **System Component Wiring** - `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/shell/system/wiring.clj`
* **Protocol Definitions** - `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/{logging,metrics,error-reporting}/ports.clj`

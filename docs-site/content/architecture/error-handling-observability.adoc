...
**Prerequisites:** Understanding of link:components.adoc[Component Architecture] and link:ports-and-adapters.adoc[Ports and Adapters]
...
1. **link:integration-patterns.adoc[Integration Patterns]** - Connecting observability to external systems

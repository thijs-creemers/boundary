...
* *Clojure CLI* (`brew install clojure/tools/clojure` or https://clojure.org/guides/install_clojure[install guide])
...
libs/tasks/src/boundary/tasks/ ├── core/ │ ├── task.clj ++#++ Pure business logic │ └── validation.clj ++#++ Validation rules ├── ports.clj ++#++ Port definitions ├── schema.clj ++#++ Data schemas └── shell/ ├── http.clj ++#++ HTTP handlers & routes ├── persistence.clj ++#++ Database adapter └── service.clj ++#++ Shell orchestration

Generated files: 12 Generated tests: 473 Lines of code: ~2,500
...
* *Examples:* See the link:../examples[examples section]
* *Issues:* https://github.com/yourusername/boundary/issues[GitHub Issues]
* *Discussions:* https://github.com/yourusername/boundary/discussions[GitHub Discussions]
...
*Next:* link:tutorial[Full Tutorial] - Build a complete task management API from scratch

'''''

=== See also

* link:tutorial.md[Full Tutorial] - Complete task management API walkthrough
* link:../guides/ide-setup.md[IDE Setup] - Configure your development environment +
* link:../guides/database-setup.md[Database Setup] - PostgreSQL configuration
* link:../guides/testing.md[Testing Guide] - Write and run tests
* link:../guides/authentication.md[Authentication Guide] - JWT auth and MFA setup

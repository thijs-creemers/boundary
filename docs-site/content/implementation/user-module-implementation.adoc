...
The user adapter implementation leverages shared type conversion utilities from `boundary.core.utils.type-conversion` and SQLite database utilities from `boundary.platform.shell.adapters.database.sqlite`:

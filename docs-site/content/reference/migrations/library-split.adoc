...
[NOTE]
====
This document intentionally includes pre-split paths (`src/boundary/...`) as migration source references.
====
...
* Repository Structure - Current canonical structure
* Development Commands - Current command reference
* link:../../architecture/overview[Architecture Overview] - FC/IS patterns (note: diagrams show pre-split paths)

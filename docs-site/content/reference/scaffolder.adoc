---
title: "Scaffolder Reference"
weight: 60
description: "Complete scaffolder command and option reference"
---
...
|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/schema.clj`
|Malli schemas for validation

|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/ports.clj`
|Protocol definitions (IService, IRepository)

|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/core/{entity}.clj`
|Pure business logic functions

|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/core/ui.clj`
|Hiccup UI component generation

|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/shell/service.clj`
|Service orchestration layer

|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/shell/persistence.clj`
|Database adapter implementation

|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/shell/http.clj`
|REST API route definitions

|`link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/shell/web_handlers.clj`
...
|`libs/{module}/test/boundary/{module}/core/{entity}_test.clj`
|Unit tests for pure core functions

|`libs/{module}/test/boundary/{module}/shell/{entity}_repository_test.clj`
|Contract tests for persistence layer

|`libs/{module}/test/boundary/{module}/shell/service_test.clj`
...
Create `link:https://github.com/thijs-creemers/boundary/blob/main/libs/{module}/src/boundary/{module}/shell/module_wiring.clj`:
...
In `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/system/wiring.clj`, add the module wiring to requires:
...
In `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/system/wiring.clj`, update the HTTP handler to accept and compose the new routes:
...
----
# Lint the module
clojure -M:clj-kondo --lint libs/{module}/src/boundary/{module}/ libs/{module}/test/boundary/{module}/
...
**Core Logic** (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/inventory/src/boundary/inventory/core/item.clj`):
[source,clojure]
----
...
**Service Layer** (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/inventory/src/boundary/inventory/shell/service.clj`):
[source,clojure]
----
...
**REST API** (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/inventory/src/boundary/inventory/shell/http.clj`):
[source,clojure]
----
["/api/items"
...
[source]
----
Directory already exists: libs/product/src/boundary/product
----
...
* link:../guides/create-module[Module Creation Guide]
* link:../guides/functional-core-imperative-shell[FC/IS Architecture]
* link:../reference/validation-patterns[Malli Schema Reference]
* link:../guides/testingreference/Testing Guide]

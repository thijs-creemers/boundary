...
weight: 30
description: "HTTP error codes and exception type mapping"
---
...
* link:../guides/add-rest-endpoint[Add a REST Endpoint]
* link:../guides/validation-system[Validation System]

...
weight: 20
description: "All configuration keys, profiles, and environment variables"
---
...
[source,{shell}]
----
export BND_STRUCTURED_LOGGING=true
export BND_WEB_UI_ENABLED=true
clojure -M:repl-clj
----

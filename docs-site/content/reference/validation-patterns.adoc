...
weight: 65
description: "Patterns, conventions, and message-style guide for Malli validation"
---
...
Path: shipping → address → postal-code
----
...
|UPDATE
|"User ID cannot be changed during update"
...
Reference user-specific rules when applicable:
...
[source]
----
"User ID cannot be changed. Create a new user if needed."
----
...
*For implementation details, see link:error-codes[Error Code Catalog]*

...
[width="100%",cols="33%,38%,29%",options="header",]
|===
...
* link:pagination.md[API Pagination] - Cursor and offset pagination
* link:../guides/database-setup.md[Database Setup] - PostgreSQL configuration
* https://www.postgresql.org/docs/current/textsearch.html[PostgreSQL Full-Text Search Docs]

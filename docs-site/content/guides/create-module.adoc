...
weight: 20
description: "Complete guide for creating a Boundary module with FC/IS structure"
---
...
TIP: **Use the Scaffolder**: The recommended approach is to use Boundary's module scaffolder, which generates production-ready modules with zero errors in seconds. See link:../reference/scaffolder[Module Scaffolder Reference] for details.
...
See link:../reference/scaffolder[Module Scaffolder Reference] for complete documentation.
...
In `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/interfaces/http/server.clj` or similar:
...
* link:add-entity[Add a Domain Entity]

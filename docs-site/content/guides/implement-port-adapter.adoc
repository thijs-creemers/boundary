...
Ports live in `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/<module>/ports.clj`.
...
Adapters live in `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/<module>/shell/persistence.clj`.
...
* link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/user/ports.clj[User Ports Example^] - Complete port definitions
* link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/user/shell/persistence.clj[Persistence Adapter^] - Full implementation

---
title: "Implement a Port and Adapter"
weight: 23
description: "How to define protocols and write adapter implementations"
---
...
Ports live in `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/ports.clj`.
...
Adapters live in `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/shell/persistence.clj`.
...
* link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/ports.clj[User Ports Example^] - Complete port definitions
* link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/shell/persistence.clj[Persistence Adapter^] - Full implementation

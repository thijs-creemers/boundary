...
weight: 21
description: "Step-by-step guide for adding a new domain entity to a Boundary module"
---
...
Add to `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/schema.clj`:
...
Add protocol to `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/ports.clj`:
...
Add to `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/shell/service.clj`:
...
Add adapter to `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/shell/persistence.clj`:
...
Add to `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/shell/http.clj`:
...
Add to `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/shell/cli.clj`:
...
- [ ] Entity conversion functions (db↔entity)
- [ ] REST endpoint added
- [ ] CLI command added
- [ ] Tests written
...
* link:implement-port-adapter[Implement Port and Adapter]
* link:add-rest-endpoint[Add REST Endpoint]

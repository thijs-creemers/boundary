...
;; For libs/user/src/boundary/user/core/user.clj:
(ns boundary.user.core.user)  ; ✅ Correct
...
clojure -M:cli user-list --user-id "$USER_ID" --format json 2>&1
----
...
* link:run-tests-and-watch[Run Tests and Watch]
* link:configure-db[Configure Database]
* link:../reference/configuration[Configuration Reference]
* link:../reference/error-codes[Error Codes Reference]
...
* ❌ *Callbacks are hidden* - `after++_++create` makes side effects invisible
...
* ✅ You need multiple interfaces (REST {plus} CLI {plus} Web)
...
* *Try the Tutorial*: link:../getting-started/your-first-module[Your First Module] - Build a blog module in 30 minutes
* *Deep Dive*: link:../guides/functional-core-imperative-shell[Functional Core / Imperative Shell] - Understand the pattern in depth
* *Architecture*: link:../guides/ports-and-adapters[Ports and Adapters] - Learn hexagonal architecture
* *Production*: link:../getting-started/deployment[Deployment Guide] - Deploy Boundary to production

...
weight: 22
description: "How to add REST endpoints to an existing Boundary module"
---
...
Handlers live in `link:https://github.com/thijs-creemers/boundary/blob/main/libs/<module>/src/boundary/<module>/shell/http.clj`.
...
[source,clojure]
----
;; In libs/user/src/boundary/user/shell/http.clj
...
[source,clojure]
----
;; Add to normalized-api-routes function in libs/user/src/boundary/user/shell/http.clj
...
[TIP]
====
HTTP interceptors provide declarative cross-cutting concerns like authentication, authorization, and audit logging. See link:../architecture/middleware-architecture[HTTP Interceptor Architecture] for details.
====
...
* ADR-008: Normalized Routing - Routing architecture
* ADR-010: HTTP Interceptors - Declarative cross-cutting concerns
* link:../api/post-users-example[API Examples] - More endpoint examples

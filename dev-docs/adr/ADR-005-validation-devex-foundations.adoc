...
`boundary.core.validation` namespace delegates to new implementations while preserving API:
...
1. **Message Templating System** (`boundary.core.validation.messages`)
...
3. **Contextual Rendering** (`boundary.core.validation.context`)
...
1. **Email Regex Pattern** (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/schema.clj`)
...
2. **Business Rule Validation Logic** (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/core/user.clj`)
...
2. ✅ `link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/schema.clj` (email regex fix)
3. ✅ `link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/core/user.clj` (business rule validation fix)
...
- [x] Implemented snapshot capture/serialize/compare/path utilities (pure) (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/snapshot.clj`)
...
- [x] Behavior DSL available with mutation helpers, scenario execution, compilation (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/behavior.clj`)
...
- [x] Coverage computation utilities (pure) (`link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/coverage.clj`)
...
- New namespace: `link:https://github.com/thijs-creemers/boundary/blob/main/dev/boundary/shared/tools/validation/repl.clj`
...
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/messages.clj` - Message templating and suggestion engine
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/context.clj` - Contextual rendering and example generation
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/codes.clj` - Error code catalog
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/result.clj` - Standard result format
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/registry.clj` - Rule registry for coverage tracking
- `link:https://github.com/thijs-creemers/boundary/blob/main/dev/boundary/shared/tools/validation/repl.clj` - REPL helpers (stats, conflicts, DOT, timing, snapshots)
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/config/feature_flags.clj` - Feature flag management
...
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/result.clj` - Standard result format
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/registry.clj` - Rule registry
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation/codes.clj` - Error code catalog
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/core/src/boundary/core/validation.clj` - Backward-compatible API

...
```
libs/admin/src/boundary/shared/ui/core/
...
**Shared UI Component Library** - `link:https://github.com/thijs-creemers/boundary/blob/main/libs/admin/src/boundary/shared/ui/core/`

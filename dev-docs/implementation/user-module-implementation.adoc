...
- `find-all-sessions`: Operational inspection, including expired and revoked
- `update-session`: Access-time refresh and expiry extension
...
- ✅ **Advanced Filtering**: Paginated queries with role, status, and email filters

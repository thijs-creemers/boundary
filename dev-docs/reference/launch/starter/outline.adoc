...
Purpose - Provide a clean template for teams to try Boundary in minutes. - Showcase FC/IS, SSR/HTMX, admin, MFA, tests, and observability with minimal setup.
...
Next Steps - Publish starter to GitHub: https://github.com/thijs-creemers/boundary-starter - Record demo using this repo - Iterate based on soft launch feedback

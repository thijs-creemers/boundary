...
**Deleted Files**:
- `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/http/pedestal_router.clj` (draft implementation)
...
3. **Reitit Adapter** (Only Implementation)
   - `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/http/reitit_router.clj`
...
- ✅ `link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/shell/http.clj` (normalized routes)
- ✅ `link:https://github.com/thijs-creemers/boundary/blob/main/libs/inventory/src/boundary/inventory/shell/http.clj` (normalized routes)
- ✅ `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/http/reitit_router.clj` (conflict fix)

**Deleted**:
- ✅ `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/http/pedestal_router.clj`
- ✅ `test/boundary/platform/shell/http/pedestal_router_test.clj`

**Deprecated**:
- ⚠️ `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/http/migration_helpers.clj`
...
- **IRouter Protocol**: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/ports/http.clj`
- **Reitit Adapter**: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/http/reitit_router.clj`
- **User Routes**: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/user/src/boundary/user/shell/http.clj`
- **Inventory Routes**: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/inventory/src/boundary/inventory/shell/http.clj`
- **System Wiring**: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/boundary/platform/shell/system/wiring.clj`

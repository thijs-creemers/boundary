...
[NOTE]
====
Historical snapshot: this report reflects repository structure and namespaces at the time of analysis. Legacy paths may appear intentionally.
====
...
==== Database Module
- [ ] Create `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/core/database/query.clj`
- [ ] Move and adapt query building functions from `boundary.platform.shell.adapters.database.common.query`
- [ ] Create `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/core/database/validation.clj`
...
==== HTTP Module
- [ ] Create `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/core/http/problem_details.clj`
- [ ] Move exception transformation logic from `boundary.platform.shell.interfaces.http.common`
- [ ] Create `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/core/http/responses.clj`
...
- [ ] Create `link:https://github.com/thijs-creemers/boundary/blob/main/src/boundary/core/database/config.clj`

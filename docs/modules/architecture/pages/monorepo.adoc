...
Boundary is a monorepo of 19 independently publishable libraries under `libs/`.
...
----
boundary/
├── src/boundary/          ← Main application (same core/shell structure)
├── libs/                  ← 19 independently publishable libraries
│   ├── core/
│   ├── observability/
│   ├── platform/
│   ├── user/
...
│   └── ecommerce-api/     ← Most comprehensive example

...
FC/IS is the single most important concept in Boundary.
...
The most common violation is when a core namespace requires a shell namespace (e.g., for logging or persistence).
clj-kondo and the test suite will catch this, but the structure is self-enforcing if you think in terms of:

= Conventions
:description: Naming conventions, field checklists, and patterns used throughout Boundary.

== Case conventions

The single most common source of bugs in Boundary projects.
...
After changing a `defrecord` definition, `(ig-repl/reset)` is not sufficient.

...
For inviting users who don't have an account yet (or whose user ID you don't know),
use the token-based external invite flow.
...
See xref:../../../libs/tenant/AGENTS.md[tenant AGENTS.md] for the full library reference.

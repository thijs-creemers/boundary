...
# Focused suites
clojure -M:test --focus boundary.tenant.core.membership-test
clojure -M:test --focus boundary.tenant.shell.membership-service-test
clojure -M:test --focus boundary.tenant.shell.invite-service-test
clojure -M:test --focus boundary.tenant.integration-test
----

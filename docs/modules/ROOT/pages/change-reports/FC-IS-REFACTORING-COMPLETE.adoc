...
**Location**: `src/boundary/core/database/query.clj`
...
**Location**: `src/boundary/core/database/validation.clj`
...
==== Updated: `boundary.shell.adapters.database.common.execution`
...
==== Updated: `boundary.shell.adapters.database.common.utils`
...
==== Updated: `boundary.shell.adapters.database.common.core`

**Changes**:
- Removed reference to `boundary.shell.adapters.database.common.query` namespace
...
**Location**: `src/boundary/core/http/problem_details.clj`
...
==== Updated: `boundary.shell.interfaces.http.middleware`
...
==== Updated: `boundary.shell.interfaces.http.common`
...
- `boundary.shell.adapters.database.common.core` - Query building functions still available
- `boundary.shell.adapters.database.common.execution` - Validation functions still available
- `boundary.shell.interfaces.http.common` - Problem details functions still available
...
1. **Extract Configuration Transformation to Core**
   - Move pure config validation from `boundary.shell.adapters.database.config`
...
2. **Create HTTP Response Builders Core Module**
   - Extract pure response builders from `boundary.shell.interfaces.http.common`

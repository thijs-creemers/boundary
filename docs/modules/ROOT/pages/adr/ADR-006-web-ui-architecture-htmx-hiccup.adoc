...
- ✅ **Tenant resolution** - Header-based with configured default fallback
...
- ✅ **Tenant Handling**: Request header with configured default fallback
- ✅ **Soft Delete**: Deactivate only, hidden from list by default

**Testing Coverage:**
- ✅ **Page handler tests**: Full page rendering, tenant resolution, error handling

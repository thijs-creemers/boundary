...
Framework-aware AI tooling for Boundary applications.
Unlike a generic AI assistant, it knows Boundary's own conventions
(FC/IS, ports, kebab↔snake naming, Malli schemas, HoneySQL syntax).

= cli
:description: Standalone project bootstrapper and module installer for Boundary. Install everything with one curl command and generate new projects with boundary new.

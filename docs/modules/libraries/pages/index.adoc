= Library Overview
:description: All 22 independently publishable Boundary libraries.

Boundary is a monorepo of 22 libraries, each independently publishable to Clojars.
...
[source,clojure]
----
{org.boundary-app/boundary-core      {:mvn/version "1.0.1-alpha-11"}
 org.boundary-app/boundary-user      {:mvn/version "1.0.1-alpha-11"}
 org.boundary-app/boundary-admin     {:mvn/version "1.0.1-alpha-11"}
 org.boundary-app/boundary-platform  {:mvn/version "1.0.1-alpha-11"}
 ;; etc.
 }
----

= Library Overview
:description: All 22 independently publishable Boundary libraries plus developer tooling.

Boundary is a monorepo of 22 libraries publishable to Clojars, plus developer tooling.
...
[source,clojure]
----
{org.boundary-app/boundary-core      {:mvn/version "1.0.1-alpha-13"}
 org.boundary-app/boundary-user      {:mvn/version "1.0.1-alpha-13"}
 org.boundary-app/boundary-admin     {:mvn/version "1.0.1-alpha-13"}
 org.boundary-app/boundary-platform  {:mvn/version "1.0.1-alpha-13"}
 ;; etc.
 }
----

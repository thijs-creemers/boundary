= Library Overview
:description: All 31 independently publishable Wagoe libraries, application and tooling alike.

Wagoe is a monorepo of 31 libraries published to Clojars under the `com.wagoe`
group.
...
{com.wagoe/wagoe-core      {:mvn/version "1.0.0-beta-8"}
 ...
 com.wagoe/wagoe-platform  {:mvn/version "1.0.0-beta-8"}
 ;; etc.
 }
----

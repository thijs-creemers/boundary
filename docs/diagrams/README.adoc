...
This directory contains PlantUML source files for all architectural and design diagrams used in Boundary documentation.

== Diagram Types

=== Architecture Diagrams
* **c4-container.puml** - C4 Container diagram showing system context
* **system-component-overview.puml** - Component diagram showing Shell and Core interaction

...
==== Purpose
Creates a new user account with role-based permissions and tenant association. This endpoint demonstrates the complete validation pipeline, core function integration, and error handling patterns of the Boundary framework.

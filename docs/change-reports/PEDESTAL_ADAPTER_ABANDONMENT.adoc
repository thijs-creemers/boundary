...
**Deleted Files**:
- `src/boundary/platform/shell/http/pedestal_router.clj` (draft implementation)
...
3. **Reitit Adapter** (Only Implementation)
   - `src/boundary/platform/shell/http/reitit_router.clj`
...
- ✅ `src/boundary/user/shell/http.clj` (normalized routes)
- ✅ `src/boundary/inventory/shell/http.clj` (normalized routes)
- ✅ `src/boundary/platform/shell/http/reitit_router.clj` (conflict fix)
...
**Deprecated**:
- ⚠️ `src/boundary/platform/shell/http/migration_helpers.clj`
...
- **User Routes**: `src/boundary/user/shell/http.clj`
- **Inventory Routes**: `src/boundary/inventory/shell/http.clj`
- **System Wiring**: `src/boundary/platform/shell/system/wiring.clj`

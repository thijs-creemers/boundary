...
1. **link:data-flow.adoc[Data Flow Architecture]** - How data flows through ports and adapters
2. **link:integration-patterns.adoc[Integration Patterns]** - Using ports and adapters in different interfaces
3. **link:configuration-and-env.adoc[Configuration and Environment Management]** - Wiring adapters based on configuration

...
1. **link:overview.adoc[Architecture Overview]** - High-level architectural decisions
2. **link:components.adoc[Component Architecture]** - Detailed module implementation patterns
3. **link:ports-and-adapters.adoc[Ports and Adapters]** - Interface design patterns

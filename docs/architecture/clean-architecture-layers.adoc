...
1. **link:migration-guide.md[Migration Guide]** - Step-by-step migration instructions
2. **link:user-module-architecture.md[User Module Architecture]** - Detailed implementation example

...
(ns boundary.shell.error-formatting
...
(ns boundary.shell.interfaces.http.user-handlers
  "HTTP handlers demonstrating complete data flow."
  (:require [boundary.shell.services.user-service :as user-service]
            [boundary.shell.validation :as validation]
            [boundary.shell.error-formatting :as error-fmt]
...
(ns boundary.shell.interfaces.cli.user-commands
...
(ns boundary.shell.interfaces.websocket.user-events
...
(ns boundary.shell.error-propagation-example

...
**Location**: `boundary.platform.shell.interfaces.http.routes/create-handler`
...
**Location**: `boundary.platform.shell.interfaces.http.routes/create-router`
...
[source,clojure]
----
;; In boundary.platform.shell.interfaces.http.routes/create-router
...
[source,clojure]
----
user=> (require '[boundary.platform.shell.interfaces.http.routes :as routes])

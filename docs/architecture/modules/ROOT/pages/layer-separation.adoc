...
(ns boundary.shell.user
  (:require [boundary.core.user :as user-core]  ; Core business logic
            ...
            [boundary.shell.db :as db]))        ; Concrete adapters

;; ❌ WRONG: Core depending on shell
(ns boundary.core.user
  (:require [boundary.shell.db :as db]))        ; ❌ Core → Shell dependency
...
(ns boundary.shell.user-test
  (:require [clojure.test :refer [deftest is testing use-fixtures]]
            [boundary.shell.user :as user-shell]

...
|`src/boundary/{module}/schema.clj`
|Malli schemas for validation

|`src/boundary/{module}/ports.clj`
|Protocol definitions (IService, IRepository)

|`src/boundary/{module}/core/{entity}.clj`
|Pure business logic functions

|`src/boundary/{module}/core/ui.clj`
|Hiccup UI component generation

|`src/boundary/{module}/shell/service.clj`
|Service orchestration layer

|`src/boundary/{module}/shell/persistence.clj`
|Database adapter implementation

|`src/boundary/{module}/shell/http.clj`
|REST API route definitions

|`src/boundary/{module}/shell/web_handlers.clj`
...
**Core Logic** (`src/boundary/inventory/core/item.clj`):
[source,clojure]
----
...
**Service Layer** (`src/boundary/inventory/shell/service.clj`):
[source,clojure]
----
...
**REST API** (`src/boundary/inventory/shell/http.clj`):
[source,clojure]
----
["/api/items"
...
* xref:how-to/create-module.adoc[Module Creation Guide]
* xref:architecture/functional-core-imperative-shell.adoc[FC/IS Architecture]
* xref:reference/malli-schemas.adoc[Malli Schema Reference]
* xref:reference/testing.adoc[Testing Guide]

...
Add to `src/boundary/<module>/schema.clj`:
...
Add protocol to `src/boundary/<module>/ports.clj`:
...
Add to `src/boundary/<module>/shell/service.clj`:
...
Add adapter to `src/boundary/<module>/shell/persistence.clj`:
...
Add to `src/boundary/<module>/shell/http.clj`:
...
Add to `src/boundary/<module>/shell/cli.clj`:
...
* xref:how-to/implement-port-adapter.adoc[Implement Port and Adapter]

...
```clojure
{:deps {org.boundary-app/boundary-storage {:mvn/version "1.0.1-alpha-27"}}}
```

**Leiningen**:
```clojure
[org.boundary-app/boundary-storage "1.0.1-alpha-27"]
```
...
|------------|---------|---------|
| `boundary/platform` | 1.0.1-alpha-27 | Configuration, database |

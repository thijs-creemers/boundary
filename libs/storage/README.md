...
```clojure
{:deps {org.boundary-app/boundary-storage {:mvn/version "1.0.1-alpha-21"}}}
```

**Leiningen**:
```clojure
[org.boundary-app/boundary-storage "1.0.1-alpha-21"]
```
...
|------------|---------|---------|
| `boundary/platform` | 1.0.1-alpha-21 | Configuration, database |

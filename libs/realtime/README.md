...
```clojure
;; deps.edn
{:deps {org.boundary-app/boundary-realtime {:mvn/version "1.0.1-alpha-27"}
        org.boundary-app/boundary-user {:mvn/version "1.0.1-alpha-27"}}}
```
...
**NEW in v1.0.1-alpha-27**: Connections can subscribe to arbitrary topics and receive messages published to those topics.
...
### Current Limitations (v1.0.1-alpha-27)
...
| `boundary/user` | 1.0.1-alpha-27 | JWT authentication (optional) |

...
```clojure
;; deps.edn
{:deps {org.boundary-app/boundary-realtime {:mvn/version "1.0.1-alpha-20"}
...
**NEW in v1.0.1-alpha-20**: Connections can subscribe to arbitrary topics and receive messages published to those topics.
...
### Current Limitations (v1.0.1-alpha-20)
...
| `boundary/user` | 1.0.1-alpha-20 | JWT authentication (optional) |

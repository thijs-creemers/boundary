...
```clojure
;; deps.edn
{:deps {org.boundary-app/boundary-realtime {:mvn/version "1.0.1-alpha-22"}
        org.boundary-app/boundary-user {:mvn/version "1.0.1-alpha-22"}}}
```
...
**NEW in v1.0.1-alpha-22**: Connections can subscribe to arbitrary topics and receive messages published to those topics.
...
### Current Limitations (v1.0.1-alpha-22)
...
| `boundary/user` | 1.0.1-alpha-22 | JWT authentication (optional) |

...
```clojure
;; deps.edn
{:deps {org.boundary-app/boundary-realtime {:mvn/version "1.0.1-alpha-15"}
...
**NEW in v1.0.1-alpha-15**: Connections can subscribe to arbitrary topics and receive messages published to those topics.
...
### Current Limitations (v1.0.1-alpha-15)
...
| `boundary/user` | 1.0.1-alpha-15 | JWT authentication (optional) |

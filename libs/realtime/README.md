...
```clojure
;; deps.edn
{:deps {org.boundary-app/boundary-realtime {:mvn/version "1.0.1-alpha-21"}
        org.boundary-app/boundary-user {:mvn/version "1.0.1-alpha-21"}}}
```
...
**NEW in v1.0.1-alpha-21**: Connections can subscribe to arbitrary topics and receive messages published to those topics.
...
### Current Limitations (v1.0.1-alpha-21)
...
| `boundary/user` | 1.0.1-alpha-21 | JWT authentication (optional) |

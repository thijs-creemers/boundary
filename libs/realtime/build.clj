...
(def lib 'com.wagoe/wagoe-realtime)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/wagoebv/wagoe"
                      ...
                      :tag version}
                :pom-data [[:description "Realtime library for Wagoe framework: WebSocket-based real-time communication with JWT authentication"]

...
(def lib 'org.boundary-app/boundary-realtime)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/thijs-creemers/boundary"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "Realtime library for Boundary framework: WebSocket-based real-time communication with JWT authentication"]
  ...
  (spit (str class-dir "/cljdoc.edn")
        (pr-str {:cljdoc/root "libs/realtime"}))

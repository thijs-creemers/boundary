...
(def lib 'com.wagoe/wagoe-calendar)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/wagoebv/wagoe"
                      ...
                      :tag version}
                :pom-data [[:description "Calendar and scheduling for Wagoe framework: recurring events, conflict detection, iCal export/import, and Hiccup UI components"]

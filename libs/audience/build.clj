...
(def lib 'org.boundary-app/boundary-audience)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/thijs-creemers/boundary"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "Audience segmentation for Boundary framework: declarative segments, hybrid evaluation, composable filters, and visual builder UI"]
  ...
  (spit (str class-dir "/cljdoc.edn")
        (pr-str {:cljdoc/root "libs/audience"}))

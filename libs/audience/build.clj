...
(def lib 'com.wagoe/wagoe-audience)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/wagoebv/wagoe"
                      ...
                      :tag version}
                :pom-data [[:description "Audience segmentation for Wagoe framework: declarative segments, hybrid evaluation, composable filters, and visual builder UI"]

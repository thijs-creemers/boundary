...
(def lib 'org.boundary-app/boundary-tenant)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/thijs-creemers/boundary"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "Multi-tenancy library for Boundary framework: schema isolation, tenant resolution, provisioning"]
  ...
  (spit (str class-dir "/cljdoc.edn")
        (pr-str {:cljdoc/root "libs/tenant"}))

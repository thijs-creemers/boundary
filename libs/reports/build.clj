...
(def lib 'com.wagoe/wagoe-reports)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/wagoebv/wagoe"
                      ...
                      :tag version}
                :pom-data [[:description "PDF and Excel report generation for Wagoe framework: Hiccup templates, declarative sections, async via jobs module"]

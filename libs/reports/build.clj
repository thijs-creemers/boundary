...
(def lib 'org.boundary-app/boundary-reports)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/thijs-creemers/boundary"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "PDF and Excel report generation for Boundary framework: Hiccup templates, declarative sections, async via jobs module"]
  ...
  (spit (str class-dir "/cljdoc.edn")
        (pr-str {:cljdoc/root "libs/reports"}))

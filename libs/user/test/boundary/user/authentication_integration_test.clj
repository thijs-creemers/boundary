...
(deftest ^:integration test-authentication-core-functions
...
(deftest ^:integration test-authentication-shell-functions
...
(deftest ^:integration test-authentication-schemas
...
(deftest ^:integration test-password-policies

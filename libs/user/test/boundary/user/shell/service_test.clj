...
(deftest ^:integration validate-session-survives-nil-update-test
...
(deftest ^:integration register-or-authenticate-user-test
...
(deftest ^:integration claim-user-identity-test
...
(deftest ^:integration permanently-delete-user-blocks-tenant-references-test
...
(deftest ^:integration user-query-operations-test
...
(deftest ^:integration user-mutation-operations-test
...
(deftest ^:integration change-password-test

...
[![Clojars Project](https://img.shields.io/clojars/v/com.wagoe/wagoe-user.svg)](https://clojars.org/com.wagoe/wagoe-user)
...
**Leiningen**:
```clojure
[com.wagoe/wagoe-user "1.0.0-beta-5"]
```
...
|------------|---------|---------|
| `wagoe/platform` | 1.0.0-beta-5 | HTTP, database |

...
```clojure
{:deps {org.boundary-app/boundary-user {:mvn/version "1.0.1-alpha-20"}}}
```

**Leiningen**:
```clojure
[org.boundary-app/boundary-user "1.0.1-alpha-20"]
```
...
|------------|---------|---------|
| `boundary/platform` | 1.0.1-alpha-20 | HTTP, database |

...
```clojure
{:deps {org.boundary-app/boundary-user {:mvn/version "1.0.1-alpha-29"}}}
```

**Leiningen**:
```clojure
[org.boundary-app/boundary-user "1.0.1-alpha-29"]
```
...
|------------|---------|---------|
| `boundary/platform` | 1.0.1-alpha-29 | HTTP, database |

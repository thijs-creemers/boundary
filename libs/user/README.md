...
```clojure
{:deps {org.boundary-app/boundary-user {:mvn/version "1.0.1-alpha-40"}}}
```

**Leiningen**:
```clojure
[org.boundary-app/boundary-user "1.0.1-alpha-40"]
```
...
|------------|---------|---------|
| `boundary/platform` | 1.0.1-alpha-40 | HTTP, database |

(ns boundary.platform.shell.adapters.database.common.core
  "Common database operations - main coordination module.
   ...
   Pure query building functions are now in boundary.platform.core.database.query
  ...
  (:require [boundary.platform.shell.adapters.database.common.connection :as connection]
            [boundary.platform.shell.adapters.database.common.execution :as execution]
            [boundary.platform.shell.adapters.database.common.schema :as schema]
            [boundary.platform.shell.adapters.database.common.utils :as utils]))
...
;; Note: Pure query building is now in boundary.platform.core.database.query
;; =============================================================================

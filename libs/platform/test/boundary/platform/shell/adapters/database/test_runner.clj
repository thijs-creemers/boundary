(ns boundary.platform.shell.adapters.database.test-runner
...
(def test-namespaces
  ...
  ['boundary.platform.shell.adapters.database.config-test
   'boundary.platform.shell.adapters.database.config-factory-test
   'boundary.platform.shell.adapters.database.integration-test])
...
;; clj -M:test -m boundary.platform.shell.adapters.database.test-runner
;; clj -M:test -m boundary.platform.shell.adapters.database.test-runner basic
;; clj -M:test -m boundary.platform.shell.adapters.database.test-runner full

...
(def lib 'org.boundary-app/boundary-core)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/thijs-creemers/boundary"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "Foundation library for Boundary framework: validation, utilities, interceptors"]

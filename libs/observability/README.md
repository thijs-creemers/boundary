...
```clojure
{:deps {org.boundary-app/boundary-observability {:mvn/version "1.0.1-alpha-28"}}}
```

**Leiningen**:
```clojure
[org.boundary-app/boundary-observability "1.0.1-alpha-28"]
```
...
|------------|---------|---------|
| `boundary/core` | 1.0.1-alpha-28 | Foundation utilities |

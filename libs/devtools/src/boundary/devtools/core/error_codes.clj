(ns boundary.devtools.core.error-codes
  "Error code catalog for Boundary.
   ...
   NOTE: This map must be kept in sync with
   libs/devtools/resources/boundary/devtools/core/error_catalog.edn,
   which is the source consumed by the Babashka CLI (bb guide error).")

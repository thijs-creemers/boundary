...
(def lib 'org.boundary-app/boundary-ai)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :scm {:url "https://github.com/thijs-creemers/boundary"
                      ...
                      :tag (str "v" version)}
                :pom-data [[:description "Multi-provider AI library for Boundary framework: Anthropic, OpenAI, Ollama"]

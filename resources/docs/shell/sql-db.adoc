...
The `elara.shell.sql-db` namespace provides a simple, straightforward gateway to SQL databases with schema-driven operations, comprehensive error handling, and detailed logging.
